 ...
 * @author AnxoPregal
 */
public class ArticulosNuevos extends javax.swing.JFrame {

    /**
     * Creates new form Conferencias
     */
    public ArticulosNuevos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblConferencia.setText("Artículo nuevo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticulosNuevos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArticulosNuevos().setVisible(true);
            }
        });
    }
